...
import { FaUsers, FaTerminal, FaTags, FaMusic, FaHistory, FaSignOutAlt, FaChartLine, FaLayerGroup } from "react-icons/fa";

const AdminSidebar = ({ theme, onLogout }) => {
  const navigate = useNavigate();
  const location = useLocation();
  const isDark = theme === "dark";

  const navItems = [
    { icon: <FaChartLine />, label: "Overview", path: "/admin/dashboard" },
    { icon: <FaUsers />, label: "Users", path: "/admin/dashboard/users" },
    { icon: <FaTerminal />, label: "Prompts", path: "/admin/dashboard/prompts" },
    { icon: <FaTags />, label: "Categories", path: "/admin/dashboard/categories" },
    { icon: <FaMusic />, label: "Tones", path: "/admin/dashboard/tones" },
    { icon: <FaLayerGroup />, label: "Templates", path: "/admin/dashboard/templates" },
    { icon: <FaHistory />, label: "Logs", path: "/admin/dashboard/logs" },
  ];
